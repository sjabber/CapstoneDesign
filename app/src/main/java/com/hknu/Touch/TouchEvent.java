package com.hknu.Touch;

import androidx.annotation.NonNull;

import com.hknu.utils.GsonUtils;
...
public class TouchEvent {
    ...
    public static final int ACTION_VOICE = 4;
...
//    }
    ...
    public static void postVoiceAction() {
        postAction(new TouchEvent(ACTION_VOICE));
    }
